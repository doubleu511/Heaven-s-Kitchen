...
[System.Serializable]
public class FostDialog
{
    public int dialogid;
    public List<FostDialogInfo> dialogInfos = new List<FostDialogInfo>();
}

[System.Serializable]
public class FostDialogInfo
{
...
public class FostDialogDic : MonoBehaviour
{
    ...
    public List<FostDialog> Dialogs;

    private Dictionary<int, FostDialog> dialogDic = new Dictionary<int, FostDialog>();
    ...
    public FostDialog GetDialog(int dialogId)
    {
        return dialogDic[dialogId];
    }

#if UNITY_EDITOR
    [ContextMenu("육성 다이얼로그 가져오기")]
    void GetDialog()
    {
    ...
    void SetDialogList(string tsv)
    {
        ...
        // 클래스 리스트
        Dialogs = new List<FostDialog>();
        FostDialog curDialog = null;
        int savedDialogId = -1;
        ...
        for (int j = 1; j < rowSize; j++)
        {
            ...
            FostDialogInfo info = new FostDialogInfo();
